<div id="mobileMenu" class="hidden bg-white shadow-lg py-4 px-6 md:hidden">
    ...
    <div class="flex flex-col space-y-4">
        <a href="/" class="text-gray font-medium text-lg py-2 border-b border-gray">Home</a>
        <a href="{{url('/about')}}" class="text-gray font-medium text-lg py-2 border-b border-gray">Sobre Nós</a>
        <a href="{{ url('/contact') }}" class="text-gray font-medium text-lg py-2 border-b border-gray">Contactos</a>
    </div>
    ...
    <div class="mt-6 flex flex-col space-y-4">
        ...
        @else
            ...
            <div class="flex flex-col space-y-2 pl-2">
                ...
                <a href="{{ route('favorites') }}" class="flex items-center py-2 text-sm text-gray-secondary">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('my-properties') }}" class="flex items-center py-2 text-sm text-gray-secondary">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Mobile CTA Button --}}
        <a href="{{ route('pages.createad.create') }}" class="relative px-6 py-2 btn-primary">
            Publicar Anúncio
        </a>
    </div>
</div>
