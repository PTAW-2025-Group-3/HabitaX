...
<nav class="w-full fixed top-0 z-50 backdrop-blur-xl bg-white/70 shadow-lg border-b border-gray-200">
    <div class="max-w-screen-xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <span class="text-2xl font-bold text-gray-900 tracking-tight">Habita<span class="text-blue-800">X</span></span>
        </div>
        ...
        <div class="hidden md:flex items-center space-x-5">
            ...
            <a href="{{ route('pages.createad.create') }}"
               class="relative inline-flex items-center justify-center px-6 py-2 bg-blue-800 text-white font-semibold rounded-xl shadow-md transition-all duration-300 hover:bg-blue-900 hover:scale-105 active:scale-95">
