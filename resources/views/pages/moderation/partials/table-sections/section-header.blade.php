<div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full">
        <h2 class="text-xl font-semibold text-gray-secondary whitespace-nowrap">{{ $title }}</h2>
        <div class="relative w-full">
            ...
            <input type="text" class="pl-10 pr-4 py-1.5 bg-white border border-gray-200 text-gray-secondary rounded-lg text-sm w-full focus:outline-none focus:ring-1 focus:ring-blue-300 focus:border-blue-300" placeholder="Pesquisar...">
        </div>
    </div>
    <div class="flex flex-wrap gap-2 items-center mt-3 sm:mt-0 shrink-0">
        ...
        @endif
        <!-- Botão de Filtros -->
        <button class="px-4 py-1.5 bg-white border border-gray-200 text-gray-secondary rounded-lg text-sm hover:bg-gray-50 flex items-center gap-2">
        ...
        <button class="p-1.5 bg-white border border-gray-200 text-gray-secondary rounded-lg text-sm hover:bg-gray-50">
