        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            ...
            <div class="border-t border-gray-200 p-6">
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-secondary">Nome</label>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-secondary">Email</label>
                        ...
                        <div>
                            <label for="bio" class="block text-sm font-medium text-gray-secondary">Biografia</label>
