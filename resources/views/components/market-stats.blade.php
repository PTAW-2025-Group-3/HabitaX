<div class="bg-white shadow rounded p-6 space-y-6">
    <h3 class="text-xl font-semibold">Dados do Mercado</h3>

    <div class="grid md:grid-cols-2 gap-6">
        <!-- Gráfico de novos anúncios -->
        <div>
            <h4 class="text-sm font-medium mb-2">Número de Novos Anúncios na Zona</h4>
            <canvas id="adsChart" height="120"></canvas>
        </div>

        <!-- Comparação com média -->
        <div>
            <h4 class="text-sm font-medium mb-2">Comparação do Preço do Imóvel com a Média da Zona</h4>
